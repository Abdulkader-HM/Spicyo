                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <div class="product_blog_img">
                                    <img src="{{ URL::asset('images/rs1.png') }}" alt="#" />
                                </div>
                            ...
                            <div class="item">
                                <div class="product_blog_img">
                                    <img src="{{ URL::asset('images/rs2.png') }}" alt="#" />
                                </div>
                                <div class="product_blog_cont">
                                    <h3>Noodles</h3>
                            ...
                            <div class="item">
                                <div class="product_blog_img">
                                    <img src="{{ URL::asset('images/rs3.png') }}" alt="#" />
                                </div>
                                <div class="product_blog_cont">
                                    <h3>Egg</h3>
                            ...
                            <div class="item">
                                <div class="product_blog_img">
                                    <img src="{{ URL::asset('images/rs4.png') }}" alt="#" />
                                </div>
                                <div class="product_blog_cont">
                                    <h3>Sushi Dizzy</h3>
                            ...
                            <div class="item">
                                <div class="product_blog_img">
                                    <img src="{{ URL::asset('images/rs5.png') }}" alt="#" />
                                </div>
                                <div class="product_blog_cont">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="about_box">
                        ...
                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of
                            ...
                            obscureContrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a
                            piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard </p>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
                    <div class="blog_box">
                        <div class="blog_img_box">
                            <figure><img src="{{ URL::asset('images/blog_img1.png') }}" alt="#" />
                        ...
                        <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those
                            ...
                            also reproduced in their exact original form, accompanied by English versions from the </p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
                    <div class="blog_box">
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="Client_box">
                        <img src="{{ URL::asset('images/me.jpeg') }}" alt="#" />
                        <h3>Abdulkader Haj Mahmoud</h3>
                        ...
                        <i><img src="{{ URL::asset('images/client_icon.png') }}" alt="#" /></i>
                    </div>
                </div>
            </div>
        </div>
