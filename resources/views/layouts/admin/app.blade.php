...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('vendors/owl-carousel-2/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('vendors/owl-carousel-2/owl.theme.default.min.css') }}">
