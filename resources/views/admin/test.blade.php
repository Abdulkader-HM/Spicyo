            ...
            <ul class="navbar-nav navbar-nav-right">
                ...
                <li class="nav-item dropdown border-left">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="{{ URL::asset('images/dashboard/faces/face4.jpg') }}" alt="image"
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="{{ URL::asset('images/dashboard/faces/face2.jpg') }}" alt="image"
                                    class="rounded-circle profile-pic">
                            </div>
                            <div class="preview-item-content">
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="{{ URL::asset('images/dashboard/faces/face3.jpg') }}" alt="image"
                                    class="rounded-circle profile-pic">
                            </div>
                            <div class="preview-item-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="py-1">
                                                <img src="{{ URL::asset('images/dashboard/faces-clipart/pic-2.png') }}"
                                                    alt="image" />
                                            </td>
                                            <td> Messsy Adam </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="py-1">
                                                <img src="{{ URL::asset('images/dashboard/faces-clipart/pic-3.png') }}"
                                                    alt="image" />
                                            </td>
                                            <td> John Richards </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="py-1">
                                                <img src="{{ URL::asset('images/dashboard/faces-clipart/pic-4.png') }}"
                                                    alt="image" />
                                            </td>
                                            <td> Peter Meggik </td>
                                            <td>
