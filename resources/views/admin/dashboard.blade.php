                        ...
                        <div class="card-body py-0 px-0 px-sm-3">
                            <div class="row align-items-center">
                                <div class="col-4 col-sm-3 col-xl-2">
                                    <img src="{{ URL::asset('images/dashboard/dashboard/Group126@2x.png') }}"
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ URL::asset('images/dashboard/faces/face1.jpg') }}"
                                                    alt="image" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ URL::asset('images/dashboard/faces/face5.jpg') }}"
                                                    alt="image" />
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="preview-list">
                                <div class="preview-item border-bottom">
                                    <div class="preview-thumbnail">
                                        <img src="{{ URL::asset('images/dashboard/faces/face6.jpg') }}" alt="image"
                                ...
                                <div class="preview-item border-bottom">
                                    <div class="preview-thumbnail">
                                        <img src="{{ URL::asset('images/dashboard/faces/face8.jpg') }}" alt="image"
                                            class="rounded-circle" />
                                    </div>
                                    <div class="preview-item-content d-flex flex-grow">
                                        <div class="flex-grow">
                                ...
                                <div class="preview-item border-bottom">
                                    <div class="preview-thumbnail">
                                        <img src="{{ URL::asset('images/dashboard/faces/face9.jpg') }}" alt="image"
                                            class="rounded-circle" />
                                    </div>
                                    <div class="preview-item-content d-flex flex-grow">
                                        <div class="flex-grow">
                                ...
                                <div class="preview-item border-bottom">
                                    <div class="preview-thumbnail">
                                        <img src="{{ URL::asset('images/dashboard/faces/face11.jpg') }}" alt="image"
                                            class="rounded-circle" />
                                    </div>
                                    <div class="preview-item-content d-flex flex-grow">
                                        <div class="flex-grow">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel"
                                ...
                                <div class="item">
                                    <img src="{{ URL::asset('images/dashboard/dashboard/Rectangle.jpg') }}"
                                        alt="">
                                </div>
                                <div class="item">
                                    <img src="{{ URL::asset('images/dashboard/dashboard/Img_5.jpg') }}" alt="">
                                </div>
                                <div class="item">
                                    <img src="{{ URL::asset('images/dashboard/dashboard/img_6.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="d-flex py-4">
                                <div class="preview-list w-100">
                                    <div class="preview-item p-0">
                                        <div class="preview-thumbnail">
                                            <img src="{{ URL::asset('images/dashboard/faces/face12.jpg') }}"
